...
- Нервная система: deep sleep (SWS) = качество восстановления НС. RHR повышенный = стресс/перетренированность. Длинное awake time (>30min), особенно утреннее раннее пробуждение — маркер тревожности и НС-напряжения. Много disturbances = поверхностный сон, НС не отпускает.
...
- Обращай особое внимание на маркеры нервной системы: deep sleep < 60min, awake > 40min, disturbances > 15, RHR выше личной нормы. Для нейроотличного человека это ключевые индикаторы. Если awake time большой — отмечай это отдельно
